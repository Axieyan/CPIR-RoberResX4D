...
class CUHKPEDES_BERT_token(data.Dataset):
    ...
    #BERT
    pklname_list = ['/content/TIPCB-Revision/BERT_id_train_64_revised.npz', '/content/TIPCB-Revision/BERT_id_val_64_revised.npz',
                    '/content/TIPCB-Revision/BERT_id_test_64_revised.npz']
    ...
    def __init__(self, root, split, max_length, transform=None, target_transform=None,
        ...
        if self.split == 'train':
            ...
            with open(os.path.join("/content/TIPCB-Revision", self.pklname), 'rb') as f_pkl:
